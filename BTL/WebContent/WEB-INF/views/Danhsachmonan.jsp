		...
		<div class="animated fadeIn">
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-sm-5">
							<h4 class="card-title mb-0">Danh mục món ăn</h4>
						...
						<div id="FoodController">
							<div class="box">
								<div class="box-header with-border">
									<h3 class="box-title">
										<a href="${pageContext.request.contextPath}/themmonan" title="Thêm Món Ăn"
								...
								<div class="box-body">
									...
									<div class="box-body-content table-responsive">
										<table>
											...
											<tr>
												<td>${food.id}</td>
												<td><img src="<c:url value="/resource/img/food/${food.anh}" />" alt="Food Image"
												...
												<td><a href="suamonan.html" title="Sửa"
